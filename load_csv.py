...
# it takes km, price as a header and generates index for every line.
# both are not indexed within the table, so values starts at [0,0]
...
def save(theta0: float, theta1: float):
